...
export type GetRewardAggregateType<T extends RewardAggregateArgs> = {
    [P in keyof T & keyof AggregateReward]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateReward[P]> : Prisma.GetScalarType<T[P], AggregateReward[P]>;
};
...
type GetRewardGroupByPayload<T extends RewardGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<RewardGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof RewardGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], RewardGroupByOutputType[P]> : Prisma.GetScalarType<T[P], RewardGroupByOutputType[P]>;
}>>;
export type RewardWhereInput = {
    ...
    user_id?: Prisma.StringFilter<"Reward"> | string;
    type?: Prisma.StringFilter<"Reward"> | string;
    credits?: Prisma.IntFilter<"Reward"> | number;
    description?: Prisma.StringFilter<"Reward"> | string;
    proof_url?: Prisma.StringNullableFilter<"Reward"> | string | null;
    status?: Prisma.StringFilter<"Reward"> | string;
    metadata?: Prisma.StringNullableFilter<"Reward"> | string | null;
    created_at?: Prisma.DateTimeFilter<"Reward"> | Date | string;
    reviewed_at?: Prisma.DateTimeNullableFilter<"Reward"> | Date | string | null;
...
export type RewardScalarWhereWithAggregatesInput = {
    ...
    user_id?: Prisma.StringWithAggregatesFilter<"Reward"> | string;
    type?: Prisma.StringWithAggregatesFilter<"Reward"> | string;
    credits?: Prisma.IntWithAggregatesFilter<"Reward"> | number;
    description?: Prisma.StringWithAggregatesFilter<"Reward"> | string;
    proof_url?: Prisma.StringNullableWithAggregatesFilter<"Reward"> | string | null;
    status?: Prisma.StringWithAggregatesFilter<"Reward"> | string;
    metadata?: Prisma.StringNullableWithAggregatesFilter<"Reward"> | string | null;
    created_at?: Prisma.DateTimeWithAggregatesFilter<"Reward"> | Date | string;
    reviewed_at?: Prisma.DateTimeNullableWithAggregatesFilter<"Reward"> | Date | string | null;
};
...
export type RewardOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "user_id" | "type" | "credits" | "description" | "proof_url" | "status" | "metadata" | "created_at" | "reviewed_at", ExtArgs["result"]["reward"]>;
...
export type RewardCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<RewardFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface RewardDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends RewardCountArgs>(args?: Prisma.Subset<T, RewardCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], RewardCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends RewardGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, RewardGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetRewardGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface RewardFieldRefs {
    ...
    readonly user_id: Prisma.FieldRef<"Reward", 'String'>;
    readonly type: Prisma.FieldRef<"Reward", 'String'>;
    readonly credits: Prisma.FieldRef<"Reward", 'Int'>;
    readonly description: Prisma.FieldRef<"Reward", 'String'>;
    readonly proof_url: Prisma.FieldRef<"Reward", 'String'>;
    readonly status: Prisma.FieldRef<"Reward", 'String'>;
    readonly metadata: Prisma.FieldRef<"Reward", 'String'>;
    readonly created_at: Prisma.FieldRef<"Reward", 'DateTime'>;
    readonly reviewed_at: Prisma.FieldRef<"Reward", 'DateTime'>;
}
/**
 * Reward findUnique
 */
